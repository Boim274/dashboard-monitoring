        ...
        <DashboardLayout>
            ...
            <div className="overflow-x-auto rounded-xl border border-gray-100">
                ...
                <tbody className="divide-y divide-gray-100">
                    ...
                    <td className="p-3 font-medium text-gray-800">Admin</td>
                    <td className="p-3 text-gray-700">082292312312</td>
                    <td className="p-3 text-gray-700">admin@gmail.com</td>
                    <td className="p-3 text-gray-700">07-06-2024</td>
            ...
            <section className="bg-white p-6 rounded-2xl shadow-md border border-gray-100 mb-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-center">
                    ...
                    <span className="text-sm font-medium text-gray-600 truncate">
                        Role: <span className="text-gray-900">All</span>
                    </span>
